function createCap_TPSdoc() {
    ...
    | copySections - Array of sections of data to copy from source Cap. Default is null. For new license typically use null (default). 01-2021 db updated for CHesterfield
    ...
    */
    ...
    try {
        ...
        // For new License use sysDateMMDDYYYY
        if (copySections == null) copySections = ["Addresses", "ASI", "ASIT", "Cap Name", "Cap Short Notes", "Conditions", "Contacts", "GIS Objects", "LPs", "Owners", "Parcels","Docuemnts"]; // Excludes Additional Info, Cap Detail, Conditions, Comments, Detailed Description, Education, ContEducation, Examination
