try {
	...
	if (TechRev != null) {
		if (!appMatch('*/*/Elevator/*') && !appMatch('*/*/*/Demolition')) {
			...
			email('techzone@chesterfieldbusiness.com','noreply@chesterfield.gov','In SUPPP - Record: ' + capId.getCustomID() + ' submitted in the Tech Zone','Date: ' + fileDate + ' For Record Type: ' + appTypeAlias);
		}
	}
