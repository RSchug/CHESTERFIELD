...
function createLP(rlpId, rlpType) {
    ...
    if (rlpObj && !rlpObj.capLicProfScriptModel) {
        ...
        if (itemCap) {
            ...
            if (capLicenseResult.getSuccess()) { capLicenseArr = capLicenseResult.getOutput(); }
...
function getLicenseProf() {
    ...
    var capLicenseResult = aa.licenseScript.getLicenseProf(itemCap);
    if (!capLicenseResult.getSuccess()) { logDebug("**ERROR: getting lic prof: " + capLicenseResult.getErrorMessage()); return false; }
    var capLicenseArr = capLicenseResult.getOutput();
    if (!capLicenseArr) { logDebug("WARNING: no license professional available on the application:"); return false; }
...
function ownerExistsOnCap() {
    ...
    if (!capOwnerResult.getSuccess()) { logDebug("**ERROR: Failed to get Owner object: " + capOwnerResult.getErrorMessage()); return false; }
